...
class ExampleCoordinator(DataUpdateCoordinator):
    ...
    def __init__(self, hass: HomeAssistant, config_entry: ConfigEntry) -> None:
        ...
        _LOGGER.info("MACVOLT: Starting up!")
        _LOGGER.info(f"MACVOLT: CONF_SCAN_INTERVAL :: {CONF_SCAN_INTERVAL}!")
        _LOGGER.info(f"MACVOLT: DEFAULT_SCAN_INTERVAL :: {DEFAULT_SCAN_INTERVAL}!")
    ...
    async def async_update_data(self):
        ...
        return MacVoltAPIData(self.api.controller_name, devices)
